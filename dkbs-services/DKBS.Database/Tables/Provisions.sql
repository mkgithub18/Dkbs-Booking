...
(
	...
	CONSTRAINT [FK_Provision_Partners] FOREIGN KEY ([PartnerId]) REFERENCES Partners([PartnerId]),
	CONSTRAINT [FK_Provision_Booking] FOREIGN KEY ([BookingId]) REFERENCES Booking([BookingId]), 
    CONSTRAINT [FK_Provision_Customer] FOREIGN KEY (CustomerId) REFERENCES Customers(CustomerId),
)
