CREATE TABLE [dbo].[ServiceRequestCommunication]
(
	[ServiceRequestCommunicationId] INT NOT NULL PRIMARY KEY IDENTITY, 
	...
	CONSTRAINT [FK_ServiceRequestCommunications_Procedures] FOREIGN KEY ([ProcedureId]) REFERENCES [Procedure]([ProcedureId])
)
